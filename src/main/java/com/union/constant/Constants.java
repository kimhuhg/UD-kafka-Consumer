...
public class Constants implements Serializable {
    ...
    public static final String ES_SHW_INDEX = "jtt_shw";
    public static final String ES_SHW_TYPY = "jtt_shw";

    public static final String ES_GPS_INDEX = "jtt_gps_test";
    public static final String ES_GPS_TYPE = "jtt_gps_test";

    public static final String ES_GPS_MISS_INDEX = "jtt_gps_miss";
    public static final String ES_GPS_MISS_TYPY = "jtt_gps_miss";

    public static final String TABLE_GPS_NAME = "jtt_gps_test";
    public static final String TABLE_SHW_NAME = "jtt_shw_test";
    public static final String TABLE_GPS_MISS_NAME = "jtt_gps_miss";

    public static final String HB_SHW_FN = "exlistinfo";
    public static final String HB_GPS_FN = "gpsdatainfo";
    public static final String HB_GPS_MISS_FN = "gpsrecordmiss";

    public static final String GPS_TOPIC = "kafka_jtt_gps_test";
    public static final String SHW_TOPIC = "kafka_jtt_shw";
    public static final String GPS_MISS_TOPIC = "jtt_gps_miss";
    public static final int batchCount = 3500;

    public static String getHtable(String topic) {
        switch (topic) {
            case GPS_TOPIC:
                return TABLE_GPS_NAME;
            case SHW_TOPIC:
                return TABLE_SHW_NAME;
            case GPS_MISS_TOPIC:
                return TABLE_GPS_MISS_NAME;
            default:
                return "";
        }
    }
